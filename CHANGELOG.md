...
- El top 3 de más jugados en "Tus partidas" suma las partidas de una
  ...
  realidad se ha jugado con una expansión suya, así que un juego
...
- El icono de carga (`LoadingSpinner`) pasa del mismo cuadrado plano de 5
  ...
  donde se use. También sube de tamaño en los 17 sitios donde aparece —
  con el nuevo diseño, a los tamaños de antes costaba distinguir qué era
  de un simple borrón. Las cuatro escalas ya existentes (14/16/20/28px,
  según el contexto: junto a texto suelto, dentro de un aviso, o como
  estado de carga de página completa) suben en bloque a 22/24/28/36px,
  mismos saltos relativos entre ellas que antes, solo desplazados hacia
  arriba.
...
- En "Añadir juego"/"Editar juego" (comparten formulario): desaparece el
  ...
  pegadas al borde izquierdo del recuadro. El mismo formulario gana
  varios puntos de corte responsive nuevos, documentados en detalle en
  `web/README.md`: por debajo de 547px, Jugadores/Duración pasan a
  ocupar toda su fila con Mínimo/Máximo repartiéndose el ancho a partes
  iguales (antes cajas pequeñas y centradas) y las etiquetas escritas
  completas, y Año de juego/Ranking/Valoración/Complejidad hacen lo
  mismo en una rejilla de 2 columnas iguales; por debajo de 428px,
  "Rellenar desde BGG" se abrevia a "Rellenar"; por debajo de 344px,
  "Edad recomendada" se abrevia a "Edad recom.".
...
- En "Tu colección", entre 741-850px, el grupo de mini-botones (vista,
