export default {
  ...
  picker: {
    title: '¿A qué jugamos?',
    playWith: 'Jugar con',
    playWithFriend: 'Con {name}',
    loadingFriendCollection: 'Cargando la colección compartida…',
    friendCollectionError: 'No se ha podido cargar esta colección. Inténtalo de nuevo.',
    someFriendCollectionsFailed: 'No se ha podido cargar la colección de {names}.',
    ownerShared: 'Compartido con {names}',
    ownerFriend: 'De {names}',
    searchLabel: 'Buscar',
  ...
  profile: {
    ...
    language: 'Idioma',
    importBggTitle: 'Importar desde BoardGameGeek',
    importBggHint: 'Trae tu colección o tu historial de partidas desde tu cuenta de BGG.',
