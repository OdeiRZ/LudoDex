export default {
  ...
  picker: {
    title: '¿A qué jugamos?',
    playWith: 'Jugar con',
    playWithNoFriend: 'Solo tu colección',
    ...
    emptyFriendCollection: 'No coincidís en ningún juego que podáis jugar juntos.',
  ...
  profile: {
    ...
    importBggHint: 'Trae tu colección, tu historial de partidas o un CSV desde tu cuenta de BGG.',
