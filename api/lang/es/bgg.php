...
return [
    ...
    'csv_expansion_not_linked_with_base_name' => 'La expansión ":name" se ha importado, pero no se ha podido enlazar con su juego base ":base_name" (no está en este mismo archivo).',
];
